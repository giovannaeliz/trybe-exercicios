document.getElementById("header-container").style.backgroundColor = "pink";
document.getElementsByClassName("emergency-tasks")[0].style.backgroundColor = "lightgreen";
document.getElementsByClassName("no-emergency-tasks")[0].style.backgroundColor = "lightblue";
